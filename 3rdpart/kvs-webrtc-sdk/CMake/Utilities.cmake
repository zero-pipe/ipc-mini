...
function(build_dependency lib_name)
  ...
  # KVS_THIRDPARTY_ROOT: sibling dirs under 3rdpart/ (mbedtls, libsrtp, ...).
  # Empty is fine for deps that still use URL/GIT download.
  ...
  execute_process(
    COMMAND ${CMAKE_COMMAND} ${build_args}
            ...
            -DKVS_THIRDPARTY_ROOT=${KVS_THIRDPARTY_ROOT}
            -G ${CMAKE_GENERATOR} .
