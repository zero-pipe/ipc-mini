...
/* Real producer-c common/Include.h when AWS Signaling is built (open-source
 * install path wins). Otherwise the PeerConnection-only stub under
 * src/include/.../common/Include.h is used — no producer-c tarball needed. */
