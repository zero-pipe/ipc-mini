...
/*
 * PeerConnection-only stub derived from producer-c v1.6.4 common/Include.h.
 * No producer-c / kvsCommonLws library. Function APIs removed; macros/types kept
 * for WebRTC Client compile. jsmn via PeerConnection/jsmn.h in Include_i.h.
 */
