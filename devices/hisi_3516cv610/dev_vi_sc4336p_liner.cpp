...
#define SC4336P_SUPPORT_MAX_W 2560
#define SC4336P_SUPPORT_MAX_H 1440

static combo_dev_attr_t g_mipi_2lane_chn0_sensor_sc4336p_10bit_4m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, SC4336P_SUPPORT_MAX_W, SC4336P_SUPPORT_MAX_H},
    .mipi_attr = {
        DATA_TYPE_RAW_12BIT,
...
static ot_isp_pub_attr g_isp_pub_attr_sc4336p_mipi_4m_30fps = {
    { 0, 0, SC4336P_SUPPORT_MAX_W, SC4336P_SUPPORT_MAX_H},
    { SC4336P_SUPPORT_MAX_W, SC4336P_SUPPORT_MAX_H},
    30,
    OT_ISP_BAYER_BGGR,
    OT_WDR_MODE_NONE,
    0,
...
namespace hisilicon{namespace dev{
    ...
    vi_sc4336p_liner::vi_sc4336p_liner(int32_t flag,int32_t w,int32_t h,int32_t fr,int32_t wdr_mode)
        :vi_isp(w,/*w*/
                h,/*h*/
                fr,/*src frame*/
                0,/*vi dev*/
                ...
                &g_sns_sc4336p_obj,/*sns obj*/
                0/*i2c dev*/,
                flag)
    {
        memcpy(&m_mipi_attr,&g_mipi_2lane_chn0_sensor_sc4336p_10bit_4m_nowdr_attr,sizeof(combo_dev_attr_t));
        memcpy(&m_isp_pub_attr,&g_isp_pub_attr_sc4336p_mipi_4m_30fps,sizeof(ot_isp_pub_attr));
        ...
        if(aiisp_enabled)
        {
            ...
            //只是测试流程，图像颜色会rb翻转
            m_isp_pub_attr.bayer_format = OT_ISP_BAYER_RGGB;
    ...
    vi_sc4336p_liner::~vi_sc4336p_liner()
    {
    }
